...
BUTTONS = {
    "choose_phone_yes": types.InlineKeyboardButton(text="Да", callback_data="Yes"),
    "choose_phone_no": types.InlineKeyboardButton(text="Нет", callback_data="No"),
...
def start(message):
    ...
    bot.send_message(message.chat.id, " Тебе это интересно?", reply_markup=show_buttons_keyboard([
